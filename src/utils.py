...
def user_console():
    ...
    platform = input("Приветствуем!\nВыберите первую букву платформы для поиска: 'HHunter' или 'Superjob' ").lower()
    vacancy = input("Введите название интересующей профессии ").lower()
    search_count = int(input("Введите желаемое количество результатов поиска "))
...
def sort_keyword(data, key):
    """Создает и возвращает список отсортированных вакансий, ключевому слову
